 ...
 * @see #builder()
 */
public final class LineInterval extends jolie.runtime.embedding.java.TypedStructure {

	private static final java.util.Set< java.lang.String > FIELD_KEYS = fieldKeys( LineInterval.class );
	...
	public LineInterval( java.lang.Integer start, java.lang.Integer end ) {
	...
	public static jolie.runtime.embedding.java.util.StructureListBuilder< LineInterval, Builder > listBuilder() {
		return new jolie.runtime.embedding.java.util.StructureListBuilder<>( LineInterval::builder );
	}

	public static jolie.runtime.embedding.java.util.StructureListBuilder< LineInterval, Builder > listBuilder(
		java.util.SequencedCollection< ? extends jolie.runtime.embedding.java.JolieValue > from ) {
		return from != null
			? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, LineInterval::from,
				LineInterval::builder )
			: listBuilder();
	}

	public static LineInterval from( jolie.runtime.embedding.java.JolieValue j )
	...
	public static LineInterval fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
	...
	public static jolie.runtime.Value toValue( LineInterval t ) {
	...
	public static class Builder {
		...
		public LineInterval build() {
			return new LineInterval( start, end );
		}
	}
}
